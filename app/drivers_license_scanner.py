...
# def get_drivers_license_info(image_path):
    ...
    if len(dlstring) > 0 and 'parsed' in dlstring[0]:
...
def decode_drivers_license_info(dlstring):
# def get_drivers_license_info(image_path):
    print('inside get_drivers_license_info')
    dl_info = {}
...
if __name__ =="__main__":
    filepath = r'C:\Development\tax-form-ocr-docker\temp.png'
    print(get_drivers_license_info(filepath,True))